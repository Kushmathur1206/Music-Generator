...
struct TORCH_API repeat_interleave_Tensor {
  using schema = at::Tensor (const at::Tensor &, c10::optional<c10::SymInt>);
  ...
  static at::Tensor call(const at::Tensor & repeats, c10::optional<c10::SymInt> output_size);
  static at::Tensor redispatch(c10::DispatchKeySet dispatchKeySet, const at::Tensor & repeats, c10::optional<c10::SymInt> output_size);
};
...
struct TORCH_API repeat_interleave_Tensor_out {
  using schema = at::Tensor & (const at::Tensor &, c10::optional<c10::SymInt>, at::Tensor &);
  using ptr_schema = schema*;
  // See Note [static constexpr char* members for windows NVCC]
  STATIC_CONSTEXPR_STR_INL_EXCEPT_WIN_CUDA(name, "aten::repeat_interleave")
  ...
  static at::Tensor & call(const at::Tensor & repeats, c10::optional<c10::SymInt> output_size, at::Tensor & out);
  static at::Tensor & redispatch(c10::DispatchKeySet dispatchKeySet, const at::Tensor & repeats, c10::optional<c10::SymInt> output_size, at::Tensor & out);
};
