...
struct TORCH_API _foreach_log10 {
  ...
  STATIC_CONSTEXPR_STR_INL_EXCEPT_WIN_CUDA(schema_str, "_foreach_log10(Tensor[] self) -> Tensor[]")
...
struct TORCH_API _foreach_log10_out {
  ...
  STATIC_CONSTEXPR_STR_INL_EXCEPT_WIN_CUDA(schema_str, "_foreach_log10.out(Tensor[] self, *, Tensor(a!)[] out) -> ()")
