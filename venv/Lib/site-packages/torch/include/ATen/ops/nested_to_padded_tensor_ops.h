...
struct TORCH_API nested_to_padded_tensor {
  ...
  STATIC_CONSTEXPR_STR_INL_EXCEPT_WIN_CUDA(name, "aten::nested_to_padded_tensor")
  STATIC_CONSTEXPR_STR_INL_EXCEPT_WIN_CUDA(overload_name, "")
  STATIC_CONSTEXPR_STR_INL_EXCEPT_WIN_CUDA(schema_str, "nested_to_padded_tensor(Tensor self, float padding, int[]? output_size=None) -> Tensor")
